...
clpo.average_credit_loan_rate, clp.join_way, clpo.credit_loan_rate_type_name, c.financial_company_name, c.disclosure_officer,
...
while($row = mysqli_fetch_array($res)) {
    ...
    'disclosure_start_to_end_date'=>$row[9]));
}
