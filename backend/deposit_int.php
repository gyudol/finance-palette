...
c.financial_company_name, c.disclosure_officer, dpo.interest_rate_type_name, 
...
while($row = mysqli_fetch_array($res)) {
    ...
    'disclosure_start_to_end_date'=>$row[11], 'interest_rate_6'=>$row[12], 'interest_rate_12'=>$row[13], 'interest_rate_24'=>$row[14], 'interest_rate_36'=>$row[15],
    'highest_interest_rate'=>$row[16]));
}
