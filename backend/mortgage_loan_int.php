...
c.financial_company_name, c.disclosure_officer, mlpo.loan_rate_type, mlpo.loan_repayment_type, mlpo.mortgage_type, 
...
while($row = mysqli_fetch_array($res)) {
    ...
    'join_way'=>$row[5], 'financial_company_name'=>$row[6], 'disclosure_officer'=>$row[7], 'loan_rate_type'=>$row[8], 'loan_repayment_type'=>$row[9], 'mortgage_type'=>$row[10], 
    'minimum_loan_rate'=>$row[11], 'average_loan_rate'=>$row[12], 'maximum_loan_rate'=>$row[13], 'disclosure_start_to_end_date'=>$row[14], 'lowest_loan_rate'=>$row[15]));
}
