...
c.financial_company_name, c.disclosure_officer, c.homepage_url, rlpo.loan_rate_type, rlpo.loan_repayment_type,
...
while($row = mysqli_fetch_array($res)) {
    ...
    'join_way'=>$row[5], 'financial_company_name'=>$row[6], 'disclosure_officer'=>$row[7], 'homepage_url'=>$row[8], 'loan_rate_type'=>$row[9], 'loan_repayment_type'=>$row[10], 'minimum_loan_rate'=>$row[11],
    'average_loan_rate'=>$row[12], 'maximum_loan_rate'=>$row[13], 'disclosure_start_to_end_date'=>$row[14], 'lowest_loan_rate'=>$row[15]));
}
