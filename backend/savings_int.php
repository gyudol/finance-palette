...
c.financial_company_name, c.disclosure_officer, c.homepage_url, spo.interest_rate_type_name, spo.accrual_type_name,
...
while($row = mysqli_fetch_array($res)) {
    ...
    'accrual_type_name'=>$row[12], 'disclosure_start_to_end_date'=>$row[13], 'interest_rate_1'=>$row[14], 'interest_rate_3'=>$row[15], 'interest_rate_6'=>$row[16], 'interest_rate_12'=>$row[17], 
    'interest_rate_24'=>$row[18], 'interest_rate_36'=>$row[19], 'highest_interest_rate'=>$row[20]));
}
